...
#define BOARD_NAME                    "Home thermostat"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "Mrazcom OOD"        // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID             "TMPL0000"            // ID of the Tile Template. Can be found in Tile Template Settings

#define PRODUCT_WIFI_SSID             "Thermostat config"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "iot.mrazcom.cc"      // Config page will be available in a browser at 'http://our-product.cc/'
